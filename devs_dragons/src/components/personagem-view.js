...
export class PersonagemView {
    ...
    criaPersonagem = (personagem) => {
        ...
        personagemLI.innerHTML = `
            <div class="container-superior">
                ...
                <div class="container-descricao">
                    <p class="descricao">${personagem.constructor.descr}</p>
                </div>
            </div>
            
            <div class="container-inferior">
                <div class="container-inferior__icones">
                    <img src="./src/assets/img/icone-mana.png" class="icone-mana" alt="Icone Mana">
                ...
                <div class="container-inferior__icones">
                    <img src="./src/assets/img/icone-vida.png" class="icone-vida" alt="Icone Vida">
        ...
        containerLevel.onclick = (evt) => {
            ...
            if (evt.target.classList.contains('diminuir-level')) personagem.levelDown();

            if (evt.target.classList.contains('aumentar-level')) personagem.levelUp();
    ...
    escutarEventoDuelo() {
        ...
        botaoDuelar.addEventListener('click', () => {
            ...
            const resultadoDuelo = Personagem.duelo(this.personagensSelecionados[0], this.personagensSelecionados[1]);
